...
parser.add_argument('--train_db_path', default='/home/data', help='the path to the root folder of the traininng data')
parser.add_argument('--test_db_path', default='/home/data', help='the path to the root folder of the traininng data')
parser.add_argument('--dataset', default='cifar100', help='the dataset to train on [cifar10]')
...
parser.add_argument('--max_epochs', default=20, type=int, help='the maximum number of epochs')  #z这里，微调和重训练都是20次
parser.add_argument('--load_path', default='./checkpoint/model-100.t7', help='the path to the pre-trained model')
