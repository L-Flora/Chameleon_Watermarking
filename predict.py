...
parser = argparse.ArgumentParser(description='Test models on CIFAR-100 and watermark sets.')
...
parser.add_argument('--db_path', default='/home/data', help='the path to the root folder of the test data')
...
if args.testwm:
    ...
    _, loader, _ = getdataloader('cifar100', args.db_path, args.db_path, batch_size)
